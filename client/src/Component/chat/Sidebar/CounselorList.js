            ...
            {counselors.map((name, index) => (
                <div className='counselor-container' key={name}>
                    ...
                    >
                        ...
                        <div className='counselor-delete-box'>
                            <div className={`counselor-delete-img ${activeButtons[index] ? '' : 'delete-hide'}`}>
                                <svg className='thread-delete-btn bi bi-trash3' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" viewBox="0 0 16 16" onClick={(e) => handleThreadDelete(e, index)}>
